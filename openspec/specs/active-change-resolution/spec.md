...
Resolve the active OpenSpec change from the current project's OpenSpec change inventory and keep its validated task snapshot current and resilient to temporary refresh failures.
